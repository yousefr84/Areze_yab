...
def openEnded(report_id, national_id, questionnaire_id):
    try:
        ...
        response = ''
        prompt = f'''
تصور کن یک مشاور ارشد مدیریت مالی و مدیریت اجرایی هستی هستی و قصد داری بر اساس مدل دوپونت و با توجه به اطلاعات صورت سود و زیان و ترازنامه، یک تحلیل مالی و مدیریتی برای مدیرعامل شرکت طوری که او بتونه برنامه استراژی کسب و کار خودشو اصلاح کنه و تقاط قوت و ضعف شرکت رو بدونه ارائه بدی. اطلاعات مالی به واحد ریال و به شرح زیر است:
{'\n'.join(messages)}''
...
در توضیحات خودت این نکته مهم رو رعایت کن که توضیحات گزارش باید به گونه ای برای مدیرعامل شرکت که آشنایی عمومی با مفاهیم مالی داره توسط تو که مشاور مالی و اجرایی مدیر هستی ارائه بشه که بتونه تصمیمات کلان و استراتژیک برای شرکتش بگیره
*گزارش هر اندازه هم که طولانی شد اما به صورت کامل و بدون وقفه تحلیل را ارائه بده*
    ...
    '''
        ...
        response += 'end first'
        prompt = f'''
        ﺖﺻﻭﺭ ﮏﻧ ﯽﮐ ﻢﺷﺍﻭﺭ ﺍﺮﺷﺩ ﻡﺪﯾﺮﯿﺗ ﻡﺎﻠﯾ ﻭ ﻡﺪﯾﺮﯿﺗ ﺎﺟﺭﺎﯿﯾ ﻪﺴﺘﯾ ﻭ ﻖﺻﺩ ﺩﺍﺮﯾ ﺏﺭ ﺎﺳﺎﺳ ﻡﺪﻟ ﺩﻮﭘﻮﻨﺗ ﻭ ﺏﺍ ﺕﻮﺠﻫ ﺐﻫ ﺎﻃﻼﻋﺎﺗ ﺹﻭﺮﺗ ﺱﻭﺩ ﻭ ﺰﯾﺎﻧ ﻭ ﺕﺭﺍﺰﻧﺎﻤﻫ، ﯽﮐ ﺖﺤﻠﯿﻟ ﻡﺎﻠﯾ ﻭ ﻡﺪﯾﺮﯿﺘﯾ ﺏﺭﺎﯾ ﻡﺪﯾﺮﻋﺎﻤﻟ ﺵﺮﮑﺗ ﻁﻭﺮﯾ ﮏﻫ ﺍﻭ ﺐﺗﻮﻨﻫ ﺏﺮﻧﺎﻤﻫ ﺎﺴﺗﺭﺎﺗﮋﯾ ﮏﺴﺑ ﻮﮐﺍﺭ ﺥﻭﺪﺷﻭ ﺎﺻﻼﺣ ﮏﻨﻫ ﻭ ﻦﻗﺎﻃ ﻕﻮﺗ ﻭ ﺾﻌﻓ ﺵﺮﮑﺗ ﺭﻭ ﺏﺩﻮﻨﻫ ﺍﺭﺎﺌﻫ ﺏﺪﯾ. ﺎﻃﻼﻋﺎﺗ ﻡﺎﻠﯾ ﺐﻫ ﻭﺎﺣﺩ ﺮﯾﺎﻟ ﻭ ﺐﻫ ﺵﺮﺣ ﺰﯾﺭ ﺎﺴﺗ:
        {'\n'.join(messages)}
        ﺏﺍ ﺕﻮﺠﻫ ﺐﻫ ﺎﻃﻼﻋﺎﺗ ﻡﺎﻠﯾ، ﻪﻤﭽﻨﯿﻧ ﺏﺭﺎﯾ ﺕﺎﺜﯾﺮﮔﺫﺍﺮﯾ ﺐﻬﺗﺭ ﺖﺤﻠﯿﻟ ﺩﻮﭘﻮﻨﺗ ﺩﺭ ﺖﺼﻤﯿﻣ ﮓﯾﺮﯾ ﻩﺍ، ﺭﺎﻬﮐﺍﺮﻫﺎﯿﯾ ﺏﺭﺎﯾ ﺐﻬﺑﻭﺩ ﻦﺴﺒﺗ ﻩﺎﯿﯾ ﮏﻫ ﻢﺣﺎﺴﺒﻫ ﮎﺭﺪﯾ ﺍﺭﺎﺌﻫ ﺏﺪﻫ . ﺏﺭﺎﯾ ﻩﺭ ﺵﺎﺨﺻ ، 3 ﺕﺍ 5 ﭗﯿﺸﻨﻫﺍﺩ ﻢﻨﺤﺻﺭ ﺐﻫ ﻑﺭﺩ ﺏﺭﺎﯾ ﺐﻬﺑﻭﺩ ﻊﻤﻠﮐﺭﺩ ﺂﻧ ﺵﺎﺨﺻ ﺏﺪﻫ ﺐﻫ ﮒﻮﻨﻫ ﺎﯾ ﮏﻫ ﺏﺍ ﺎﯿﻧ<200c>ﮔﺯﺍﺮﺷ ﮏﻫ ﺏﺭﺎﯾ ﻡﺪﯾﺮﻋﺎﻤﻟ ﺵﺮﮑﺗ ﮏﻫ ﺂﺸﻧﺎﯿﯾ ﻊﻣﻮﻤﯾ ﺏﺍ ﻢﻓﺎﻬﯿﻣ ﻡﺎﻠﯾ ﺩﺍﺮﻫ ﺕﻮﺴﻃ ﺕﻭ ﮏﻫ ﻢﺷﺍﻭﺭ ﻡﺎﻠﯾ ﻭ ﺎﺟﺭﺎﯿﯾ ﻡﺪﯾﺭ ﻪﺴﺘﯾ ﺂﻣﺍﺪﻫ ﺵﺪﻫ ﺐﺗﻮﻨﻫ ﺏﺭﺎﯾ ﺎﺴﺗﺭﺎﺗﮋﯾ ﺂﯿﻧﺪﻫ ﺵﺮﮑﺗ ﺏﺮﻧﺎﻤﻫ ﺮﯾﺰﯾ ﮎﻼﻧ ﮏﻨﻫ ﺏﺪﯿﻬﯾ ﻪﺴﺗ ﮏﻫ ﺎﯿﻧ ﮒﺯﺍﺮﺷ ﺏﺎﯾﺩ ﺐﻫ ﺰﺑﺎﻧ ﺱﺍﺪﻫ ﺎﻣﺍ ﺍﺯ ﺪﯾﺪﮔﺎﻫ ﺖﺨﺼﺼﯾ ﯽﮐ<200c>ﻤﺷﺍﻭﺭ ﻥﻮﺸﺘﻫ ﺐﺸﻫ
         ﻑﺮﻤﺗ ﺍﺭﺎﺌﻫ ﺭﺎﻬﮐﺍﺮﻫﺍ ﺐﻫ ﺶﮑﻟ ﺰﯾﺭ ﺏﺎﺷﺩ:
        ﺖﺤﻠﯿﻟ ﺵﺎﺨﺻ ﺡﺎﺸﯿﻫ ﺱﻭﺩ ﺥﺎﻠﺻ ﺩﺭ 2 ﭖﺍﺭﺎﮔﺭﺎﻓ ﻭ 120 ﮏﻠﻤﻫ
        *ﭗﯿﺸﻨﻫﺍﺩ ﺍﻮﻟ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        *ﭗﯿﺸﻨﻫﺍﺩ ﺩﻮﻣ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        *ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        *ﭗﯿﺸﻨﻫﺍﺩ ﺱﻮﻣ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        *ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        *ﭗﯿﺸﻨﻫﺍﺩ ﭻﻫﺍﺮﻣ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        *ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        *ﭗﯿﺸﻨﻫﺍﺩ ﭗﻨﺠﻣ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        *ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        ﺖﺤﻠﯿﻟ ﺵﺎﺨﺻ ﮒﺭﺪﺷ ﺩﺍﺭﺎﯿﯾ ﻩﺍ ﺩﺭ 2 ﭖﺍﺭﺎﮔﺭﺎﻓ ﻭ 120 ﮏﻠﻤﻫ
        *ﭗﯿﺸﻨﻫﺍﺩ ﺍﻮﻟ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        *ﭗﯿﺸﻨﻫﺍﺩ ﺩﻮﻣ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        *ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        ...
        *ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        *ﭗﯿﺸﻨﻫﺍﺩ ﭗﻨﺠﻣ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        ﺖﺤﻠﯿﻟ ﺵﺎﺨﺻ ﺎﻫﺮﻣ ﻡﺎﻠﯾ ﺩﺭ 2 ﭖﺍﺭﺎﮔﺭﺎﻓ ﻭ 120 ﮏﻠﻤﻫ
        *ﭗﯿﺸﻨﻫﺍﺩ ﺍﻮﻟ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        *ﭗﯿﺸﻨﻫﺍﺩ ﺩﻮﻣ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        *ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        ...
        *ﺐﻫ ﻁﻭﺭ ﻢﺛﺎﻟ: (ﺕﻮﻀﯿﺣ ﻢﺛﺎﻟ ﻊﻤﻠﯾﺎﺘﯾ)*
        *ﭗﯿﺸﻨﻫﺍﺩ ﭗﻨﺠﻣ: (ﺕﻮﻀﯿﺣ ﭗﯿﺸﻨﻫﺍﺩ ﺐﻬﺑﻭﺩ)*
        *ﺕﺎﮑﯾﺩ ﻢﯿﮑﻨﻣ ﮒﺯﺍﺮﺷ ﻩﺭ ﺎﻧﺩﺍﺰﻫ ﻪﻣ ﮏﻫ ﻁﻭﻼﻨﯾ ﺵﺩ ﺎﻣﺍ ﺐﻫ ﺹﻭﺮﺗ ﮎﺎﻤﻟ ﻭ ﺏﺩﻮﻧ ﻮﻘﻔﻫ ﺭﺎﻬﮐﺍﺮﻫﺍ ﻭ ﻢﺛﺎﻟ ﻩﺍ ﺭﺍ ﺍﺭﺎﺌﻫ ﺏﺪﻫ*

        '''
        response += openAI(prompt, rule)
        print(prompt)
        result_data = {"messages": response, "domain": 'تحلیل صورت های مالی'}
        questionnaire.report = result_data
        questionnaire.is_paid = True
        questionnaire.save()
        report_obj.result = result_data
...
نکته: قبل از شروع جدول بنویس "شروع جدول" و بعد از پایان جدول بنویس "پایان جدول"
اطلاعات عمومی در پایین ارسال میشود:
{'\n'.join(messages)}

    '''
        rule = f'''
        تصور کن یک کارشناس مالی هستی و قصد داری با توجه به اطلاعات صورت سود و زیان و ترازنامه، یک تحلیل مالی برای شرکت ارائه بدی.
    '''
        response += openAI(prompt, rule)
        print(prompt)
        response += 'end first'
...
'''
        ...
        response += openAI(prompt, rule)
        print(prompt)
        result_data = {"messages": response, "domain": 'بررسی اعتبار مالی شرکت'}
        questionnaire.report = result_data
        questionnaire.is_paid = True
        questionnaire.save()
        report_obj.result = result_data
